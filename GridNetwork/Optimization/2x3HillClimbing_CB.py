...
if __name__ == '__main__':
    ...
    stepSizes = [0.5] + [3]*5
    plotFolderPath = "../Plots/HillClimbing_CB_2x3_5runs_strat2_1500veh/" #CAUTION!!!:change before running --> create new folder for each optimization experiment
    hillClimbing = HillClimbing(evalFunc, params, stepSizes)
    hillClimbing.optimize(plotFolderPath=plotFolderPath, epsilon=0.001, maxIter=50, numRuns=4, strategy=2, paramValidCallbacks=[checkCTFactor], useGradient=False, reduceStepSize = True)