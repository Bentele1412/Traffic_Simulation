...
if __name__ == '__main__':
    ...
    setFlows(900, 3600, "../2x3.flow.xml")
    ...
    hillClimbing.optimize(plotFolderPath=plotFolderPath, epsilon=0.001, maxIter=50, numRuns=5, strategy=1, paramValidCallbacks=[checkCTFactor], useGradient=False)